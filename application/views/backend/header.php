 <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="#"><b><img src="<?php echo base_url();?>uploads/logo.png" class="img-fluid" alt="home" /></b><span class="hidden-xs"><strong>
                ...
                <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            ...
                            <!-- <li><a href="<?php echo base_url();?>login/logout"><i class="ti-settings"></i>  Account Setting</a></li> -->
